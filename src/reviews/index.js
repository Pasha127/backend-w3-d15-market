...
reviewRouter.post("/:productId", checkReviewSchema, checkValidationResult, async (req,res,next)=>{
    try{
...
//add a pic to a comment
/* reviewRouter.put("/images/:reviewId/pic",cloudinaryUploader, async (req,res,next)=>{try{     
